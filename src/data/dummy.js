...
import { getUserAvg } from "../apiHelper";
...
export const earningData = async () => {
  // const { userAggregate } = useStateContext();
  let userAggregate = await getUserAvg()
  console.log('useragg',userAggregate.average)
  return [
    {
      icon: <MdOutlineSupervisorAccount />,
      amount: userAggregate.average.totalRecords,
      percentage: "",
      title: "Total Records",
      iconColor: "#03C9D7",
      iconBg: "#E5FAFB",
    ...
    {
      icon: <BsBoxSeam />,
      amount: userAggregate.average.totalAmount,
      percentage: "",
      title: "Total Loan",
    ...
    {
      icon: <FiBarChart />,
      amount: ((Number( userAggregate.average.totalAmount * userAggregate.average.averageInterest) - Number(userAggregate.average.totalAmount))/100).toFixed(2) ,
      percentage: "",
    ...
    },
    {
      ...
      amount: userAggregate.average.averageInterest.toFixed(2),
      percentage: "",
